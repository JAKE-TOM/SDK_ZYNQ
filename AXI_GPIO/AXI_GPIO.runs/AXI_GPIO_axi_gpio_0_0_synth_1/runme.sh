...
HD_PWD='D:/ZYNQ_Mizar-7010/04_SDK_Demo/5_AXI_GPIO/AXI_GPIO/AXI_GPIO.runs/AXI_GPIO_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_GPIO_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_GPIO_axi_gpio_0_0.tcl
