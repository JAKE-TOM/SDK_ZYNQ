...
HD_PWD='F:/FPGA/5_AXI_GPIO/AXI_GPIO/AXI_GPIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_GPIO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_GPIO_wrapper.tcl -notrace
