...
HD_PWD='F:/FPGA/5_AXI_GPIO/AXI_GPIO/AXI_GPIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_GPIO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_GPIO_wrapper.tcl
